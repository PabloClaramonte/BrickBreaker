...
{
	if (BALA.POSICION.X > _COLUMNA.POSICION.X - (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.X < _COLUMNA.POSICION.X + (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.Z < _COLUMNA.POSICION.Z + _COLUMNA.TAMANOCOLUMNA && BALA.POSICION.Z > _COLUMNA.POSICION.Z + (_COLUMNA.TAMANOCOLUMNA / 3))
	{
		//BALA.POSICION.Z = _COLUMNA.POSICION.Z + _COLUMNA.TAMANOCOLUMNA;
		//BALA.VELOCIDAD = 0.0;
		return true;
	}
	else if (BALA.POSICION.X > _COLUMNA.POSICION.X - (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.X < _COLUMNA.POSICION.X + (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.Z > _COLUMNA.POSICION.Z - _COLUMNA.TAMANOCOLUMNA && BALA.POSICION.Z < _COLUMNA.POSICION.Z + (_COLUMNA.TAMANOCOLUMNA / 3))
	{
		//BALA.POSICION.Z = _COLUMNA.POSICION.Z - _COLUMNA.TAMANOCOLUMNA;
		//BALA.VELOCIDAD = 0.0;
		return true;
	}
	else if (BALA.POSICION.Z > _COLUMNA.POSICION.Z - (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.Z < _COLUMNA.POSICION.Z + (_COLUMNA.TAMANOCOLUMNA / 3) && BALA.POSICION.X > _COLUMNA.POSICION.X - _COLUMNA.TAMANOCOLUMNA && BALA.POSICION.X < _COLUMNA.POSICION.X - (_COLUMNA.TAMANOCOLUMNA / 3))
	{
